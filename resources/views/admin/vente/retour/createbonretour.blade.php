            ...
            <div class="col">
                <div class="card">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        Créer une facture
                        <a href="{{ route('listeRetourVente')}}" class="btn btn-outline-secondary btn-sm" type="submit">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="mb-3 col-lg-4">
                                    ...
                                    <input type="text" class="form-control" name="brnumero" id="brnumero" value="{{ old('brnumero')}}"/>
                                </div>
                                <div class="mb-3 col-lg-4">
                                ...
                                <div class="mb-3 col-lg-4">
                                    ...
                                    <input type="date" class="form-control" name="brdate" id="brdate" value="{{ old('brdate')}}"/>
                                </div>
                            </div>
...
<script>
    ...
    bonLivraisonSelect.addEventListener('change', function() {
        ...
        .then(data => {
            ...
            const clientId = data.fournisseur_id;
        ...
        success: function(response) {
            swal({
                ...
                closeOnClickOutside: false
                 ...
                 window.location.href = "{{ env('APP_URL') }}/bon-retour-vente/detail/" + response.id;
            });
        },
