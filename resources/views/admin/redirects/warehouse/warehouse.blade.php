...
<div class="page-content">
    <div class="container-fluid">
        ...
        <div class="d-flex mb-3 justify-content-end">
            <button type="button" class="btn btn-warning fw-bold text-white"  data-bs-toggle="modal" onclick="changeBtn()" data-bs-target=".WarehouseModal"> Ajouter un  Warehouse</button>
        </div>
