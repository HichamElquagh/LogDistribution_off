    ...
    <div class="row">
      <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
          <h4 class="mb-sm-0">Fournissuers Detail</h4>
          <div class="page-title-right">
            <ol class="breadcrumb m-0">
              <li class="breadcrumb-item"><a href="javascript: void(0);">Log Dist Du Nord</a></li>
              <li class="breadcrumb-item active">Fournissuers Detail</li>
            </ol>
          </div>
        </div>
      </div>
        ...
        <div class="col-md-6 mx-auto">
          <div class="card border-1 rounded shadow-sm custom-card">
            <div class="card-header bg-secondary text-white">
              <h5 class="mb-0 text-light text-center">Fournisseur Information</h5>
            </div>
            <div class="card-body">
              <div class="row mb-2">
